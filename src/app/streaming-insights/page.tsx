    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="prose max-w-none mb-8">
        ...
        <ol className="list-decimal list-inside space-y-2 text-gray-600">
          ...
          <li>
            Select &quot;Extended streaming history&quot; and request your data
          </li>
          <li>
            Wait for Spotify to prepare your data (this can take up to 30 days)
          </li>
          <li>
        ...
        <p className="text-gray-600 mt-4">
          Your data will be processed entirely in your browser and won&apos;t be
          sent to any server.
        </p>
      </div>
